...
def main():
    ...
    start_file = "j12038_1.data"  # File bắt đầu
    end_file = "j1209_9.data"  # File kết thúc
    ...
    local_path = "result/j120_with_bound_900s_2.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/j120_with_bound_900s_2.csv"
